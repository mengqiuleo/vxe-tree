    ...
    <div class="example">
      ...
      <div class="op-btns">
        <ElTooltip content="在 Github 中编辑" :show-arrow="false">
          <div style="margin-left: 5px;"><el-icon @click="toGithub"><Link /></el-icon></div>
        </ElTooltip>
        <ElTooltip content="复制代码" :show-arrow="false">
          <div style="margin-left: 25px;"><el-icon @click="copyCode"><DocumentCopy /></el-icon></div>
        </ElTooltip>
        <ElTooltip content="查看源代码" :show-arrow="false">
          <div style="margin-left: 25px;"><el-icon  @click="toggleSourceVisible()"><Edit /></el-icon></div>
        </ElTooltip>
      </div>
      ...
      <Transition name="el-fade-in-linear">
        <div
          ...
          <div name="ArrowTopBold" @click="copyCode"></div>
          <span>隐藏源码</span>
        </div>
      </Transition>
    </div>
...
import { Link, DocumentCopy, Edit  } from '@element-plus/icons-vue';
import { useClipboard, useToggle, isClient } from "@vueuse/core";
import { ElTooltip, ElCollapseTransition, ElMessage  } from "element-plus";
import SourceCode from "./vxe-code.vue";
